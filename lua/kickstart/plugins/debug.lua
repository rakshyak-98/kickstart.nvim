...
return {
  ...
  dependencies = {
    ...
    { 'rakshyak-98/vscode-js-debug', build = 'npm install --legacy-peer-deps && npx gulp vsDebugServerBundle && mv dist out' },
  },
  config = function()
    local dap = require 'dap'
    local dapui = require 'dapui'
    local dpavscode = require 'dap-vscode-js'
    ...
    -- Dap setup javascript and typescript
    dpavscode.setup {
